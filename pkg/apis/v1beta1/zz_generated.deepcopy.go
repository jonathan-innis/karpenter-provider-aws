...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FiltersAndOwners) DeepCopyInto(out *FiltersAndOwners) {
	*out = *in
	if in.Filters != nil {
		in, out := &in.Filters, &out.Filters
		*out = make([]*ec2.Filter, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ec2.Filter)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FiltersAndOwners.
func (in *FiltersAndOwners) DeepCopy() *FiltersAndOwners {
	if in == nil {
		return nil
	}
	out := new(FiltersAndOwners)
	in.DeepCopyInto(out)
	return out
}
