...
func NewEnvironment(ctx context.Context, env *coretest.Environment) *Environment {
	...
	instanceTypesProvider := instancetype.NewProvider(ctx, fake.DefaultRegion, instanceTypeCache, ec2api, subnetProvider, unavailableOfferingsCache, pricingProvider)
