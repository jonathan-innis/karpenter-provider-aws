...
var _ = BeforeEach(func() {
	...
	env = test.NewEnvironment(ctx, func(e *test.Environment) {
		...
		infraController = polling.NewController(infrastructure.NewReconciler(infrastructure.NewProvider(sqsProvider, eventBridgeProvider)), polling.Options{})
		controller = polling.NewController(notification.NewReconciler(env.Client, recorder, cluster, sqsProvider, instanceTypeProvider, infraController), polling.Options{})
	})
